...
export default async function StoolChartPage({
  ...
  return (
    <div>
      ...
      <div className="mb-3 bg-gray-50 rounded-lg p-3 text-xs text-gray-600 flex flex-wrap gap-x-4 gap-y-1 items-center">
        <span className="font-medium text-gray-500">記号の意味：</span>
        <span><span className="text-green-700 font-bold">○</span> 良好</span>
        <span><span className="text-amber-700 font-bold">△</span> 軟便／少ない</span>
        <span><span className="text-red-700 font-bold">×</span> 下痢</span>
        <span><span className="text-slate-500 font-bold">－</span> 出なかった</span>
      </div>
